...
<body>
    <div class="headermenu">
        <div class="menu">
            <ul>
                ...
                <li><a href="viewinfoinst_stu.php">User Info</a></li>
    ...
    <div class="search">
            ...
            if (!empty($_POST['query'])) {
                ...
                if (count($result)>0) {
                  // Loop through the results and display them
                    ...
                    echo "<td>{$result['state']}</td>" ;
                    echo "<td><a class='btn' href='update.php?p_name= {$result['p_name']} &self_id= {$result['self_id']}' type='button'><i class='fa-solid fa-pen'></i></a>&nbsp
                   " ;
                    echo "</tr>" ;
                  }
                    endforeach;
        ...
        <div class="table-users">
            <div class="header">Projects <a class="addBtn" href="add_others.php" title="Edit"><i
