...
<body>
    ...
    <form action="?" method="post">
            ...
            if (!empty($_POST['query'])) {
                ...
                if (count($result)>0) {
                  // Loop through the results and display them
                    ...
                    echo "<td>{$result['state']}</td>" ;
                    echo "<td><a class='btn' href='update.php?p_id={$result['p_id']}' type='button'><i class='fa-solid fa-pen'></i></a>&nbsp
                    <a class='btn' href='?delete={$result['p_id']}' type='button'><i class='fa-solid fa-trash-can'></i></a></td>" ;
                    echo "</tr>" ;
                  }
                    endforeach;
                    echo "</table>";
        ...
        <div class="table-users">
            <div class="header">Projects <a class="addBtn" href="add_admin.php" title="Edit"><i
